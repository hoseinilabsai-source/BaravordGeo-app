...
export default function App() {
  ...
  return (
    <div className="w-full h-[100dvh] bg-slate-50 flex flex-col relative text-slate-900 font-sans overflow-x-hidden" dir="rtl">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        {flowScreen === 'auth' && (
          <div className="flex-grow flex flex-col justify-between p-5 bg-white">
            <div>
              ...
              <div className="flex justify-center items-center mt-6 mb-8 gap-2">
                {[1, 2, 3, 4].map((stepNum) => {
